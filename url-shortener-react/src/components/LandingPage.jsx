      ...
      <div className="sm:pt-12 pt-7">
        ...
        <div className="pt-4 pb-7 grid lg:gap-7 gap-4 xl:grid-cols-4  lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-4">
          ...
          <Card
            ...
            desc="Instantly generate, customize, and download QR codes for your links. Access our standalone generator or use dashboard QR codes for quick sharing."
          />
          <Card
            title="Custom Aliases & Expiry"
            desc="Create recognizable vanity URLs for better branding. Set specific expiration dates to automatically disable links and manage your active links easily."
          />
        </div>
      </div>
    </div>
