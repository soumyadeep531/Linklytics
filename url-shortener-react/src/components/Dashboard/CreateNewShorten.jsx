      ...
      >
        ...
        <div className="mt-4 text-left">
            ...
            <input 
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-customRed focus:border-customRed sm:text-sm"
            />
        </div>
